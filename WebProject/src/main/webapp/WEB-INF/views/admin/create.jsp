                        ...
                        <div class="col-md-9" style="transform: translateX(10%);">
                            <div class="card"  >
                                <div class="card-header">
                                    <h2 class="card-title"> Thêm Truyện</h2>
                                </div>
                                <form:form  modelAttribute="story" style="margin-left: 10%;" enctype="multipart/form-data" action="create.html" >
                                    ...
                                    <div class="row g-2 align-items-center" style="margin-top: 2%; margin-bottom:2%;">
                                        ...
                                        <div class="col-md-6">
                                            <form:select path="story.idAuthor" style="min-width: 30%;" aria-label=".form-select-lg example"
                                             items="${Authors}" itemValue="id" itemLabel="name" class="form-select"  id="author" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-2 align-items-center" style="margin-top: 2%; margin-bottom:2%;">
                                        ...
                                        <div class="col-md-6">
                                            <form:input path="image" type="file" class="form-control-file" id="image-input" />
                                       	    <img src="#" class="img-thumbnail" id="image-show">
