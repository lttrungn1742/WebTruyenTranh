...
<body>
        ...
        <div class="row" style="margin-top: 100px;background:#E7ECF0;">
            <div class="row" style="margin-top:5%; margin-bottom:5%">
            	...
            	<div class="col">
            		 ...
            		 <div class="col">
	                        	<a href="${pageContext.servletContext.contextPath}/all.html"><span style="padding: 5px;background-color:#F94364" class="border  rounded-pill">Tất cả </span></a>
		                    </div>
                 		<c:forEach var="iterator" items="${category}" >
	                   
		                    <div class="col">
	                        	<a href="${pageContext.servletContext.contextPath}/all/${iterator.getId()}.html"><span id="span-${iterator.getId()}" style="padding: 5px;background-color:#F94364" class="border rounded-pill">${iterator.getName()}</span></a>
		                    </div>
		             </c:forEach>		
    ...
    <script>
        ...
        $("#span-"+parseInt("${id}")).attr("style","padding: 5px;background-color:#0CE6FA");
    </script>
